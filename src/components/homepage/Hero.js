...
export default function Hero(){
    return (
        <div className="container-fluid hero section mt-1 p-0 d-flex flex-wrap justify-content-start">
            <div className='hero-image m-0 col-12'>
                <img src="https://bornparkadventures.com/wp-content/uploads/2020/06/Maasai-Crafts-2048x1378.jpg" alt=""/>
            </div>
